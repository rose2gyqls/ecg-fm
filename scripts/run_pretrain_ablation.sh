#!/bin/bash
# scripts/run_pretrain_ablation.sh
#
...
#
# Usage:
#   nohup ./scripts/run_pretrain_ablation.sh > pretrain_ablation.log 2>&1 &
#
# Override:
#   GPUS=0,1,2,3,4      ./scripts/run_pretrain_ablation.sh       # GPU 지정 (default: 0~4, 5개)
#   ONLY=cb512          ./scripts/run_pretrain_ablation.sh       # 단일 config만 실행 (쉼표 구분)
#   SKIP=cb256          ./scripts/run_pretrain_ablation.sh       # 특정 config 제외 (쉼표 구분)
#   FORCE_RESTART=1     ./scripts/run_pretrain_ablation.sh       # 완료 stamp 무시 재실행
...
ALL_CONFIGS=(
  "cb512:configs/pretrain/masked_beat_heedb_cb512.yaml"
  "cb256:configs/pretrain/masked_beat_heedb_cb256.yaml"
  "cb1024:configs/pretrain/masked_beat_heedb_cb1024.yaml"
  "cb2048:configs/pretrain/masked_beat_heedb_cb2048.yaml"
)
...
LOG_ROOT="logs/pretrain_ablation_runs"
...
echo "============================================================"
echo "  ECG-FM  |  Pretrain Codebook Ablation"
